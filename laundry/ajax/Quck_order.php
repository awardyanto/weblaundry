...
$insert = "insert into user_registration(User_Name,Password,Address,Contact_No)
             VALUES('".$_POST['name']."','".$_POST['phone']."','".$_POST['Address']."','".$_POST['phone']."','".$_POST['Saldo']."')";
...
if($info){
   ...
   $sql="SELECT * From order_detail Where Pick_up_date='".$_POST['P_date']."' and Delivery_date='".$_POST['D_date']."' and Total_Item='".$_POST['Total_item']."' and Total_Price='".($_POST['Laundry']+$_POST['Dry'])."'";
    $sql1=$db->query($sql);
    ...
    if($sql1->num_rows<=0) {
        ...
        VALUES ('".$USER_ID."','".$Order_Code."','".$USER_Name."','".$_POST['Total_item']."','".(($_POST['Laundry']+$_POST['Dry'])*$_POST['Total_item'])."','".$_POST['P_date']."','".$_POST['D_date']."','".$_POST['phone']."','".$_POST['Address']."','No','No')";
